...
export const ResumenPrincipal = () => {
  console.log(LocalidadesV2.CandidaturaUno.años[0].totalCais);
  const data1 = [
  ...
  return (
    <div className='flex flex-col p-5 items-center gap-6'>
      <span className='text-xl'>Total de cai en la alcaldia de:</span>
      ...
      <div>
        <span className='text-xl'>Total en la alcaldia de:</span>
        <VictoryChart domainPadding={20}>
          <VictoryLegend
            ...
            data={[
              ...
              { name: 'Hospitales', symbol: { fill: 'white' } },
            ]}
          />
          ...
          <VictoryBar data={data2} x="x" y="y" style={{ data: { fill: 'white' } }} />
        </VictoryChart>
      </div>
    </div>
  )
